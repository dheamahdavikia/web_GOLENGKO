...
<body>
	...
	$result=(mysqli_query($conn, "SELECT * FROM makanan where id_makanan='$_GET[del]'"));
	...
	<body>
		<div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">EDIT MAKANAN</h1>
                        <br>
                        ...
                        <form method="post" action="edit_makanan.php" enctype="multipart/form-data">
                            <fieldset>
                                <div class="form-group">
                                	<input type="hidden" name="id" value="<?php echo $re['id_makanan']; ?>">
                                    <p>NAMA MAKANAN</p>
                                    <input class="form-control" placeholder="nama_makanan" name="nama_makanan" type="text" value="<?php echo $re ['nama_makanan'];?> " autofocus>
                                </div>
                                <div class="form-group">
                                    <p>HARGA</p>
                                    <input class="form-control" placeholder="harga_makanan" name="harga_makanan" type="text" value="<?php echo $re ['harga'];?>"autofocus >
                                </div>
...
<?php
    ...
    if (isset($_POST['submit'])) {
		...
		$sql = "update makanan  set nama_makanan='$nama_makanan', harga='$harga' where id_makanan='$id'";
