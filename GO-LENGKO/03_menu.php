        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white pt-90">
                                <h5><b>SEGO LENGKO</b></h5>
                                <h2 class="mt-30 mb-15">GO-LENGKO</h2>
                        </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
        </div><!-- container -->
</section>
...
<section class="story-area left-text center-sm-text">
        <div class="container">
                <div class="heading"><h3>SILAHKAN ORDER</h3></div>
                <div class="row">
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        ...
                                        <h5 class="mt-20">Original</h5>
                                        <h4 class="mt-5 color-primary"><b>Rp. 10.000</b></h4>
                        ...
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        ...
                                        <h5 class="mt-20">Lengko Bakar</h5>
                                        <h4 class="mt-5 color-primary"><b>Rp. 17.000</b></h4>
                                </div><!--text-center-->
                        </div><!-- col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4  col-sm-6 ">
                                <div class="center-text mb-30">
                                        ...
                                        <h5 class="mt-20">Tempe Tahu</h5>
                                        <h4 class="mt-5 color-primary"><b>Rp. 15.000</h4>
                                </div><!--text-center-->
                        </div><!-- col-md-3 -->
                       ...
                       <!--  <div class="col-lg-3 col-md-4  col-sm-6 ">
                                 <div class="center-text mb-30">
                                        ...
                                        <h5 class="mt-20">Suiran Ayam </h5>
                                        <h4 class="mt-5 color-primary"><b>Rp. 21 .000</h4>
                                </div><!--text-center-->
                        </div><!-- col-md-3 -->
                </div><!-- row-->
        </div><!-- container -->
