...
<ul class="nav">
        ...
        <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu"  href="index_admin.php"><i class="fa fa-dashboard "></i>DATA PESANAN</a>
                    </li>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a href="delete_pesanan.php">delete</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                     <!-- <tr>
    ...
    <!-- /. WRAPPER  -->
    <footer >
        &copy; 2015 e-commerce GO-LENGKO| By : <a href="http://www.designbootstrap.com/" target="_blank">DHEA MAHDAVIKIA/a>
    </footer>
    <!-- /. FOOTER  -->
